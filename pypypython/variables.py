...
print ('students_counts je typ: ' + type(students_count).__name__ + ' a adresa je: ' + hex(id(students_count)))
print ('rating je typ: ' + type(rating).__name__ + ' a adresa je: ' + hex(id(rating)))
print ('is_published je typ: ' + type(is_published).__name__ + ' a adresa je: ' + hex(id(is_published)))
...
hexboi = '1a'
print(myself_binary,' je binarni hodnota myslef_binary a ', int(str(myself_binary), 2),' je decimalni hodnota')
bitpos = int(str(myself_binary), 2) >> 2
print(bitpos,' je myself_binary po bitovem posunu.')
#mytohex = hex(int(myself_binary,2))
#multiply = mytohex & hexboi
hexboibin = bin(int(hexboi, 16))[2:].zfill(8)
#print(myself_binary, int(hexboibin))
multiply = int(str(myself_binary), 2) & int(hexboibin, 2)
print('Bitovey soucin cisel %d a %s je: '%(myself_binary, hexboibin),multiply)
